...
//+------------------------------------------------------------------+
    ...
    msg+=StringFormat("Account:%i ,Server:%s:\n",AccountInfoInteger(ACCOUNT_LOGIN),AccountInfoString(ACCOUNT_SERVER));
    msg+=StringFormat("Balance $: %2.4f,%s\n",AccountInfoDouble(ACCOUNT_BALANCE),currency);
    msg+=StringFormat("Profit $: %2.4f, %s\n",AccountInfoDouble(ACCOUNT_PROFIT),currency);
   msg+=StringFormat("Equity $:%2.4f , %s\n ",AccountInfoDouble(ACCOUNT_EQUITY),currency); 
   msg+=StringFormat("Margin   $: %2.4f ,%s\n",AccountInfoDouble(ACCOUNT_MARGIN),currency); 
   msg+=StringFormat("Margin_Free $:%2.4f,%s  \n",AccountInfoDouble(ACCOUNT_FREEMARGIN),currency); 
   msg+=StringFormat("Margin_Level $: %2.4f,%s \n",AccountInfoDouble(ACCOUNT_MARGIN_LEVEL),currency); 
   msg+=StringFormat("Margin_So_Call $: %2.4f,%s\n",AccountInfoDouble(ACCOUNT_MARGIN_SO_CALL),currency); 
   msg+=StringFormat("Margin_So_So $:%2.4f,%s",AccountInfoDouble(ACCOUNT_MARGIN_SO_SO),currency); 
